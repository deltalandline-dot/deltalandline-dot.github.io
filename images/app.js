import {configured,listPhotos,publishPhoto,preparedPhoto,accessToken,signIn,acceptSignInLink,signOut,listCollection,setPhotoFeatured,removePhoto} from '../shared/connection.js?v=5cd7cc2bcefb';
import {DISPLAY_MS,choosePhoto,frameSize} from './gallery.js?v=5cd7cc2bcefb';
